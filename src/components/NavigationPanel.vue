...
<template>
  <header class="navbar">
    <div class="navbar__container page-container">
      <router-link
        class="navbar__logo"
        to="home"
      >
      ...
      >
        <summary class="navbar__dropdown">
          <ImgTemplate
            class="navbar__dropdown-avatar"
            :src="user.avatar"
          />
          <span class="navbar__dropdown-nickname">
            {{ user.nickname }}
          </span>
          <SvgTemplate
            class="navbar__dropdown-marker"
            icon-id="dropdown-arrow"
            view-box="0 0 12 7"
          />
          <div class="navbar__burger">
            <div class="navbar__burger-item" />
          </div>
        </summary>
        <aside class="navbar__dropdown-details">
          <button class="navbar__button navbar__dropdown-link">
            Сменить аккаунт
          </button>
